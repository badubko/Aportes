...
DROP SCHEMA IF EXISTS aportesV16;
...
CREATE TABLE t_users2 (
  ...
  especialidad SET ('Administración','Coaching','Comercial','Comunicacion',
  'Contable','Diagnostico','Estrategia',
  'Indicadores','Logistica','Negocios','Procesos',
  'RRHH','Sistemas','No Informada') DEFAULT 'No Informada',
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  KEY idx_fk_dni (dni),
...
CREATE TABLE t_roles (
	...
	descr_rol VARCHAR (40) DEFAULT NULL,
	PRIMARY KEY (rol)
	)ENGINE=InnoDB DEFAULT CHARSET=utf8;
